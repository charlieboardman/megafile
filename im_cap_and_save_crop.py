...
def capture_image():
    ...
    while True:
        filename = input("Enter a filename for the PDF (without .pdf extension): ")
        if filename:
...
if __name__ == "__main__":
    pdf_bytes, pages = capture_image()
    if pdf_bytes is not None and pages is not None:
        print("Image capture, PDF conversion, and file saving completed.")
    else:
        print("Process terminated without saving.")
